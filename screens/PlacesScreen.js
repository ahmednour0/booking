...
const PlacesScreen = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      place: "Hyderabad",
      placeImage:
        "https://images.pexels.com/phothos/9373357/pexels-photo-9373357.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerTintColor: "white",  // Change the back arrow color to white (or any color you prefer)
    });
  }, []);
